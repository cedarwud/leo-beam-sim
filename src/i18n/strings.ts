...
export const ZH_TW = {
  ...
  'panel.energyComparison.subtitle': '以 50 dBm 與 35 dBm 的相同量測窗口比較實際資料；服務關卡未通過時不宣稱節能。',
...
export const EN: Record<I18nKey, string> = {
  ...
  'panel.energyComparison.subtitle': 'Compare actual data in matched windows at 50 dBm and 35 dBm; no energy-saving claim survives failed service gates.',
