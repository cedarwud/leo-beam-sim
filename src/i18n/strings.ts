...
export const ZH_TW = {
  ...
  'panel.energyComparison.title': '教學能源比較',
  'panel.energyComparison.subtitle': '凍結相同量測窗口的基準與候選，依四項關卡判定。',
...
export const EN: Record<I18nKey, string> = {
  ...
  'panel.energyComparison.title': 'Teaching energy comparison',
  'panel.energyComparison.subtitle': 'Freeze a baseline and a candidate from the same measurement window, then evaluate four gates.',
