...
export const SIX_ACTS_PHASES: readonly SixActsPhaseSpec[] = Object.freeze([
  Object.freeze({
    ...
    beat: 'before',
    titleZhHant: '接手初期',
    narrationZhHant: '這顆衛星剛接手你的連線。先看清楚它現在的幾何：仰角多少、多遠、訊號多好。',
  ...
  Object.freeze({
    ...
    beat: 'before',
    titleZhHant: '品質下滑',
    narrationZhHant: '衛星在西沉。距離拉長、離軸角變大、仰角變低——三件事同時發生，訊號一路往下。',
  ...
  Object.freeze({
    ...
    beat: 'before',
    titleZhHant: '候選出現',
    narrationZhHant: '第二條曲線進場。候選排行榜列出每顆的訊號、仰角、還剩多久可見。',
  ...
  Object.freeze({
    ...
    beat: 'decision',
    titleZhHant: '條件判斷',
    narrationZhHant: '規則攤開來看：候選要比服務好過門檻，而且要持續整段 TTT。條件就在這一秒成立。',
  ...
  Object.freeze({
    ...
    beat: 'decision',
    titleZhHant: '執行換手',
    narrationZhHant: '跳線。換手收據記下這次的代價：中斷多久、訊令成本、換來多少訊號增益。',
  ...
  Object.freeze({
    ...
    beat: 'after',
    titleZhHant: '新常態',
    narrationZhHant: '數值回穩。新的服務衛星也會西沉——所以這整件事會一直重來。',
