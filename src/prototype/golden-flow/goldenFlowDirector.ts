...
export const GOLDEN_FLOW_BEATS: readonly GoldenFlowBeat[] = Object.freeze([
  ...
  freezeBeat({
    ...
    eyebrow: '06 · 比較候選集合',
    caption: ['目前只有一條服務鏈路。', '三顆候選只提供 SINR 比較值，尚未連線。'],
    primaryCue: 'candidate-arrival',
    learningQuestion: '系統如何從候選集合選出換手目標？',
    visiblePhenomenon: '服務波束維持單一；三顆候選以虛線比較值呈現，並依 SINR 排出目前最佳目標。',
    ...
    causalExplanation: '系統先在候選集合中選出最佳比較值，再把該目標與目前服務 SINR 比較；排名第一不等於立即換手。',
    misconceptionGuard: '候選比較值不代表第二條服務鏈路；此處不是 DAPS 或雙連線。',
  ...
  freezeBeat({
    ...
    visiblePhenomenon: '服務波束仍只有一條；候選比較值與目前服務的差值跨越 3 dB 門檻。',
