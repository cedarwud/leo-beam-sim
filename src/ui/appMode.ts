...
import { HANDOVER_MODE_STORAGE_KEY } from './useModqnHandoverState';
...
export const APP_MODE_HANDOVER_MAP: Readonly<Record<AppExperienceMode, 'sinr-offset' | 'decision-overlay-on-live-sinr'>> = {
...
export function appModeForRuntimeHandover(
  mode: 'sinr-offset' | 'decision-overlay-on-live-sinr' | 'omega-heuristic',
): AppExperienceMode | null {
