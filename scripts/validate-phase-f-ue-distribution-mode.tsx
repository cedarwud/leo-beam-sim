...
section('(e) TopologyTab source testids and radio options', () => {
  ...
  check(
    countOccurrences(topologyTabSource, 'topology-tab-') >= priorTopologyTestIds.length + distributionTestIds.length,
    'TopologyTab.tsx contains at least the preserved and distribution testid string literals',
  );
